...
| 4 (Sep 29)| Value Iteration and Policy Iteration | Value and Policy Iterations for FrozenLake [lab](https://github.com/manyouma/DRL_sztu/blob/main/labs/Lab04_frozenLake_VI_PI_solution.ipynb)|
